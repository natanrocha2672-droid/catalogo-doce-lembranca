...
const PRODUCTS = [
...

  {
    ...
    image: "Gemini_Generated_Image_u7l0yau7l0yau7l0.png",
...

  {
    ...
    image: "WhatsApp Image 2026-05-04 at 18.09.46 (1).jpeg",
...
export default function App() {
  ...
  const sendWhatsApp = () => {
    ...
    // Link configurado com o seu número

    window.open(`https://wa.me/553299909706?text=${encodedMessage}`, '_blank');
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-1 relative w-full max-w-lg">
            ...
            <img 
              ...
              src="WhatsApp Image 2026-05-04 at 18.09.46 (1).jpg" 
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <button 
                ...
                className="w-10 h-10 rounded-xl bg-rose-50 flex items-center justify-center text-rose-500 hover:bg-rose-500 hover:text-white transition-all shadow-sm"
